...
class RandomText {
  ...
  private static String[] customers = {"O5 COUNCIL", "ULTRAMARINES", "UNSC SWC", "1 FW", "633d ABW"};
  private static String[] producers = {"SITE-17", "AREA-51", "SG-1", "10IS", "DGS-1"};
  private static String[] countries = {"HKG", "VAT", "GRL", "PRK", "ETK"};
  private static String[] adjectives1 = {"angry", "rapid", "lucky", "slowly", "non"};
  private static String[] adjectives2 = {"Responsive", "Inverted", "Downtrodden", "Optional", "Primary"};
  private static String[] nouns = {"Koala", "Racecar", "Screwdriver", "Statue", "Dinasaur"};
  private static String[] tlds = {"com", "org", "net", "xyz", "gov"};
  private static String[] reports = {"a report", "a bluf", "statistics", "figures", "analysis"};
  private static String[] organizations = {"secret police's", "special forces'", "colonial marines'", "intelligence agency's", "citizens'"};
  private static String[] actions = {"facilities within", "influence on", "operations against", "conspiracies about", "destruction of"};
  private static String[] locations = {"the moon", "krakatowa", "the nether", "Washington DC", "Langley AFB"};
...
public class RandomRfi {
  public RandomText get = new RandomText();
...
//  @Test
//  public void displayRandomRfi(){
//    RandomRfi randomRfi = new RandomRfi();
//    System.out.println(randomRfi.toRfi());
//    System.out.println(randomRfi.toRfi());
//    System.out.println(randomRfi.toRfi());
//    System.out.println(randomRfi.toRfi());
//    System.out.println(randomRfi.toRfi());
