...
public class RFIControllerTest extends BaseIntegrationTest {
  private static String firstRequestText = "hi";

  private static String secondRequestText = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do " +
  ...
  public void rfiTest() {
    given()
      ...
      .body("[0].requestText",  equalTo(firstRequestText))
      ...
      .body("[14].requestText",  equalTo(secondRequestText));
  }
}
