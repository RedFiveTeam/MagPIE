...
describe('Region', () => {
  ...
  beforeEach(() => {
    ...
    rows = [
      <RfiRow
        rfi={new RfiModel('19-001', 'url', RfiStatus.OPEN, '1 FW', moment('2019-12-01').utc(), 'USA', 'hi', -1, null, null)}
        key={'1'}
        scrollRegionRef={{}}
        index={0}
      />,
      <RfiRow
        rfi={new RfiModel('19-004', 'url', RfiStatus.OPEN, '633 ABW', moment('2019-12-02').utc(), 'CAN', 'hi', -1, null, null)}
        key={'2'}
        scrollRegionRef={{}}
        index={1}
      />,
      <RfiRow
        rfi={new RfiModel('19-003', 'url', RfiStatus.OPEN, 'HQ ACC', undefined, 'MEX', 'hi', -1, null, null)}
        key={'3'}
        scrollRegionRef={{}}
        index={2}
      />,
