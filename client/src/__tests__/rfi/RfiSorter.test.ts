...
describe('RFISorter', () => {
  ...
  beforeEach(() => {
    rfiList = [
      new RfiModel(1, '19-001', '', RfiStatus.OPEN, '1 FW', moment.utc('2019-12-01'), 'USA', 'hi', 3, 0, 0),
      new RfiModel(2, '19-004', '', RfiStatus.OPEN, '633 ABW', moment.utc('2019-12-02'), 'CAN', 'hi', 2, 0, 0),
  ...
  it('should not sort closed', () => {
    rfiList = [
      new RfiModel(1, '19-001', '', RfiStatus.CLOSED, '1 FW', moment.utc('2019-12-01'), 'USA', 'hi', 3, 0, 0),
      new RfiModel(2, '19-004', '', RfiStatus.CLOSED, '633 ABW', moment.utc('2019-12-02'), 'CAN', 'hi', 2, 0, 0),
      new RfiModel(3, '19-003', '', RfiStatus.CLOSED, 'HQ ACC', undefined, 'MEX', 'hi', 1, 0, 0)
    ];
