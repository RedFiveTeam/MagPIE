...
describe('RfiActions', () => {
  ...
  let rfi1 = new RfiModel(1, '19-001', '', undefined, RfiStatus.OPEN, '', '', '', '1 FW', '', '', '', '', '',
                          moment.utc('2019-12-01'), 'USA', 'hi', 'Just a fiction', 1, 0, 0, undefined, false, false);
  let rfi2 = new RfiModel(2, '19-004', '', undefined, RfiStatus.OPEN, '', '', '', '633 ABW', '', '', '', '', '',
                          moment.utc('2019-12-02'), 'CAN', 'hi', 'Just a fiction', 2, 0, 0, undefined, false, false);
  let rfi3 = new RfiModel(3, '19-003', '', undefined, RfiStatus.OPEN, '', '', '', 'HQ ACC', '', '', '', '', '',
                          undefined, 'MEX', 'hi', 'Just a fiction', 3, 0, 0, undefined, false, false);
  let rfi4 = new RfiModel(4, '19-007', '', undefined, RfiStatus.OPEN, '', '', '', 'HQ ACC', '', '', '', '', '',
                          undefined, 'MEX', 'hi', 'Just a fiction', 4, 0, 0, undefined, false, false);
  let rfi5 = new RfiModel(5, '19-009', '', undefined, RfiStatus.OPEN, '', '', '', 'HQ ACC', '', '', '', '', '',
                          undefined, 'MEX', 'hi', 'Just a fiction', 5, 0, 0, undefined, false, false);
